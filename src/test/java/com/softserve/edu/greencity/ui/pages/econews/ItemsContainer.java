...
//        itemComponents = new ArrayList<>();
//        for (WebElement current : driver.findElements(By.cssSelector("div.list-gallery-content"))) {
//            itemComponents.add(new ItemComponent(driver, current));
//        }
//    }
//
...
//    }
//
//    public ItemComponent getItemComponentByTitle(String title){
//        ItemComponent result = null;
//        System.out.println("TITLE :: "+title);
//        for (ItemComponent cur : getItemComponents()) {
//            if (cur.getTitle().toString().equals(title)) {
//                result = cur;
//            }
//        }
//        return result;
